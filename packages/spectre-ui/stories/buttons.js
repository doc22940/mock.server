...
const DocButtons = (): React$Element<*> => (
	<Doc
		title="Buttons"
		desc="Buttons include simple button styles for actions in different types and sizes."
	>
		<DocSection>
		...
		<DocSection title="Button sizes">
			<DocElement id="buttons2">
				...
				<Button
					modifier="primary"
					label="normal button"
					onClick={action("clicked normal button")}
				/>
				<br />
				<br />
				<Button
				...
				<Button
					...
					modifier="primary"
					label="block button"
					onClick={action("clicked block button")}
				/>
			</DocElement>
			<DocCode id="buttons2" />
		</DocSection>
		<DocSection title="Action button">
			<DocElement id="buttons3">
				...
				<div>
					<Button
						modifier="action circle"
						size="lg"
						onClick={action("clicked action circle button")}
					/>{" "}
					<Button
						modifier="action circle"
						onClick={action("clicked action circle button")}
