...
DTOToClassConverter.prototype = extend(DTOToClassConverter.prototype, {
	...
	init: function (name, dtoJson, options) {
		...
		//this._classStr = JSON.stringify(this._json, null, 2);
		//this._classStr = JSON.stringify(this.normalize(this._json), null, 2);
		...
		//	this.readFile(__dirname + '/../src/templates/dto_' + this._options.jsVersion + '.dot'));
		//this._classStr = template(extend(this._normalized, {
		//	className: name,
		//	classNameDecapitalize: this.decapitalize(name),
		//	options: this._options
		//}));
