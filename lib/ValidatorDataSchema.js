...
ValidatorDataSchema.prototype = extend(ValidatorDataSchema.prototype, {
	...
	init: function (options) {
		...
		this.writeFile(this._path + '/mock/.' + this._expected + '_validation', JSON.stringify({
			counter: this._invalidCounter
		}, null, 2));
