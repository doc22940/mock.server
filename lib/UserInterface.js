...
UserInterface.prototype = extend(UserInterface.prototype, {
	...
	get: function (type) {
		...
		switch (type) {
			case 'data': return _._data;
			case 'apiData': return _._data;
			case 'dataDto': return _._dataDto;
			case 'swaggerImport': return _._swaggerImport;
			case 'validation': return _._validation;
			case 'isSwaggerImportAvailable': return _._isSwaggerImportAvailable;
			case 'isCustomDTOToClassAvailable': return _._isCustomDTOToClassAvailable;
		}
